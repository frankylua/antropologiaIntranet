                ...
                <div class="collapse navbar-collapse justify-content-end" id="menu">
                    <ul class="navbar-nav  mb-2 mb-lg-0 ">
                        ...
                        <li class="nav-item mx-2">
                            ...
                            <?php endif; ?>
                            <?php if (isset($_SESSION['admin']) || isset($_SESSION['comite'])|| isset($_SESSION['aceptado'])|| Authorization::hasCapability('perfil.ver')|| isset($_SESSION['docente']) || Authorization::hasCapability('cursos.ver')): ?>
                                <li class="nav-item dropdown mx-2">
                                    <a class="nav-link  dropdown-toggle" id="listaIngreso" data-bs-toggle="dropdown"
                                    ...
                                    <li><a href="<?php echo RUTA; ?>admin/act.list.php" class="dropdown-item">Actualizar
                                        Listas</a></li>
                                        <?php endif; ?>
                                        <?php if (Authorization::hasCapability('cursos.ver')): ?>
