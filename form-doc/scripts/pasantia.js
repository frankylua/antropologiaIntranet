...
$('#btn_pasantia').click(function () {
    ...
    ajaxSelect('#inst_pasant', ruta + 'ajax/institucion.php', 'Seleccione', 'read', undefined, 'id_inst', 'inst');
    ajaxSelect('#pais_pasant', ruta + 'ajax/pais.php', 'Seleccione', 'pais', undefined, 'id_pais', 'pais');
